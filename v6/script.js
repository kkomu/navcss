(function() {
    ...
    $('ul[role="menubar"] > li.has-children').hover(function() {
        ...
        $(this).children('ul.child-menu').css("display", "inline");
    }, function() {
        ...
        if( menuElement.is(':not(:first-child)')) {
            ...
            $(menuElement).children('ul.child-menu').css("display", "inline");
        }
    ...
    function showClickedMenu() {
        ...
        if( selectedElement.is(':not(:first-child)')) {
            ...
            $(selectedElement).children('ul.child-menu').css("display", "inline");
